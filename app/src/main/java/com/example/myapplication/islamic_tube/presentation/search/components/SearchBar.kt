package com.example.myapplication.islamic_tube.presentation.search.components
        ...
        TextField(
            ...
            trailingIcon = {
                Icon(
                    ...
                    tint = colorResource(id = R.color.slate_gray)
                )
            },
            placeholder = {
                Text(
                    text = stringResource(R.string.search_screen_search),
